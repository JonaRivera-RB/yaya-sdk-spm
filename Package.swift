...
let package = Package(
    ...
    targets: [
        .binaryTarget(name: "YAYASDK", url: "https://github.com/JonaRivera-RB/yaya-sdk-spm/releases/download/v1.0.1/YAYASDK.xcframework.zip", checksum: "9e2b0782e157fc7577420e30147f9470b8b3f43dc699699818abcad07bc5bc1e"),
